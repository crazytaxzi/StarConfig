...
internal static class Program
{
    ...
    private static void Install()
    {
        ...
        var installedInstaller = Path.Combine(InstallDir, "StarConfig-Setup.exe");
        File.Copy(currentInstaller, installedInstaller, true);

        var appExe = Path.Combine(InstallDir, "StarConfig.exe");
    ...
    private static void RegisterUninstaller(string installerPath)
    {
    ...
    private static void Uninstall()
    {
        ...
        var cleanupScript = Path.Combine(Path.GetTempPath(), $"StarConfig-Uninstall-{Guid.NewGuid():N}.cmd");
